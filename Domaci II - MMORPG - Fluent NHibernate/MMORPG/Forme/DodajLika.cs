    ...
    public partial class DodajLika : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboKlasa.Text == "LOPOV")
            {
                ...
                o.Id = Convert.ToInt32(textBox1.Text);
                ...
                DTOManager.sacuvajLika(o, comboKlasa.Text, comboRasa.Text,Convert.ToInt32(txtZamke.Text),Convert.ToInt32(txtNivoBuke.Text), txtReligija.Text,txtBlagoslov.Text,Convert.ToChar(comboLecenje.Text), Convert.ToChar(comboLuk.Text), Convert.ToInt32(txtOklop.Text), Convert.ToChar(comboObeRuke.Text), Convert.ToChar(comboStit.Text), txtMagije.Text);
                MessageBox.Show("Uspesno ste dodali novog lika!");
                this.Close();
            }
